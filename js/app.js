...
const vm  = new Vue({
  ...
  data: { 
    skills: [
      ...
      {title: "SASS", logo:"https://upload.wikimedia.org/wikipedia/commons/thumb/9/96/Sass_Logo_Color.svg/220px-Sass_Logo_Color.svg.png", level: 80},
      ...
      {title: "Vue.js", logo:"https://upload.wikimedia.org/wikipedia/commons/thumb/c/ce/Vue.svg/220px-Vue.svg.png", level: 70},
      {title: "Firebase", logo:"https://seeklogo.com/images/F/firebase-logo-402F407EE0-seeklogo.com.png", level: 60},
      {title: "Webpack", logo:"https://upload.wikimedia.org/wikipedia/commons/thumb/c/c1/Webpack.png/100px-Webpack.png", level: 60},
      ...
      {title: "Django", logo:"https://cdn-images-1.medium.com/max/1200/1*1OBwwxzJksMv0YDD-XmyBw.png", level: 60},
      {title: "GO", logo:"http://ipengineer.net/wp-content/uploads/2016/05/gopher.png", level: 50},
      {title: "PostgreSQL", logo:"https://upload.wikimedia.org/wikipedia/commons/thumb/2/29/Postgresql_elephant.svg/1200px-Postgresql_elephant.svg.png", level: 60},
